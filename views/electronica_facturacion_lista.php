           ...
           <div class="aui-application-list-generic-header">
               <div class="aui-application-list-generic-header-button">
                   <div style="display: flex;">
                       <div tabindex="-1" data-href="Facturacionelectronica-data" class="aui-kit-actionbutton aui-kit-actionbutton-only-icon aui-kit-actionbutton-template-action-bar aui-kit-actionbutton-version-V1"  > 
                   ...
                   <div class="container-fluid" style="padding-bottom: 20px;">
                       ...
                       <table id="dtVta" class="display nowrap responsive-table" cellspacing="0" width="100%" style="font-size: 0.775em;">
                            ...
                            <tr>
                                    ...
                                    <td  data-label="Fecha">15-03-2025</td>
                                    <td  data-label="No_doc">145454-add457-erere4878-78787drere</td>
                                    <td  data-label="Tipo_doc">LP SOFTWARE</td>
                                    <td  data-label="Nombre_comercial">LP,S.A. DE C.V.</td>
                                    <td  data-label="Nombre_legal">01-FACTURA</td>
