           ...
           <div class="aui-application-list-generic-header">
               <div class="aui-application-list-generic-header-button">
                   <div style="display: flex;">
                       <div tabindex="-1" data-href="facturacion-data" class="aui-kit-actionbutton aui-kit-actionbutton-only-icon aui-kit-actionbutton-template-action-bar aui-kit-actionbutton-version-V1"  > 
